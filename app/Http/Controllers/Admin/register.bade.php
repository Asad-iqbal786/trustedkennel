                        ...
                        <div class="row">
                            <div class="col-md-12 mx-0">
                                <form id="msform" method="post" action="{{ route('newRegister') }}"
                                    ...
                                    <ul id="progressbar">
                                        <li class="active" id="account"><strong>KENNAL</strong></li>
                                        <li id="personal"><strong>OWNER</strong></li>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-card">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" 
                                                            ...
                                                            value="{{ old('kennel_name') }}"  required placeholder="kennel_name">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" 
                                                            name="state" id="state" required value="{{ old('state') }}"
                                                            placeholder="state">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="country">COUNTRY</label>
                                                        <input type="text" class="form-control" 
                                                            name="country" id="country" required value="{{ old('country') }}"
                                                            placeholder="country">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" min="1900" required max="2099"
                                                            step="1" value="2023" class="form-control"
                                                            name="established_year" id="established_year">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="owner_First_neame">KENNEL</label>
                                                        <input type="text" class="form-control"
                                                            value="{{ old('owner_First_neame') }}" 
                                                            name="owner_First_neame"required id="owner_First_neame"
                                                            value="" placeholder="owner_First_neame">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="first_neame">FIRST NAME</label>
                                                        <input type="text" class="form-control"
                                                            value="{{ old('first_neame') }}" 
                                                            name="first_neame"required id="first_neame" value=""
                                                            placeholder="first_neame">
                                                    </div>
                                                </div>
                                                <div class="form-group col-6">
                                                    <label for="last_name">LAST NAME </label>
                                                    <input id="last_name"required type="text" class="form-control"
                                                         name="last_name">
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="email">EMAIL</label>
                                                        <input type="emain"required class="form-control"
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="registration_number">KENNEL REGISTRATION NUMBER </label>

                                                        <input id="text"required type="text" class="form-control"
                                                             name="registration_number" tabindex="2">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                        ...
                                        <input type="button" name="next"required class="next action-button"
                                            value="Next Step" />
                                    </fieldset>
                                    {{-- <fieldset>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="about"required value="{{ old('about') }}" id="about" cols="30" rows="10"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="health_check" required value="{{ old('health_check') }}" id="health_check" cols="30" rows="10">{{ old('health_check') }}</textarea>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="url"
                                                            class="form-control"value="{{ old('facebook_url') }}"
                                                             name="facebook_url"required id="facebook_url"
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="recent_img">A RECENT PICTURE OF YOUR KENNEL FACILITIES</label>
                                                        <input type="file"required class="form-control" id="recent_img"
                                                        name="recent_img">
                                                    </div>
                                                </div>
                                                {{-- <div class="col-6">
