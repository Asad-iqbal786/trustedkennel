                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="elder" name="home_style"
                                                    class="custom-control-input" value="appartment">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="previous_expierience" id="summernote" class="form-control summernote" cols="30" rows="5">
                                                    ...
                                                    @if (empty($productData['previous_expierience']))
                                                    
                                                    @else
                                                        {{ $productData['previous_expierience'] }}
                                                    @endif
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="plan_for_other_puppy" id="summernote" class="form-control summernote" cols="30" rows="2">
                                                            ...
                                                            @if (!empty($productData['plan_for_other_puppy']))
                                                            {{ $productData['plan_for_other_puppy'] }}
                                                            @else
                                                            @endif
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="how_to_integrate" id="" class="form-control summernote" cols="30" rows="2">
                                                        ...
                                                        @if (empty($productData['how_to_integrate']))
                                                        @else
                                                            {{ $productData['how_to_integrate'] }}
                                                        @endif
                                                    </textarea>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="descrbe_living_secuation" id="" class="form-control summernote" cols="30" rows="4">
                                                        ...
                                                        @if (empty($productData['descrbe_living_secuation']))
                                                        @else
                                                            {{ $productData['descrbe_living_secuation'] }}
                                                        @endif
                                                    </textarea>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="puppu_spent_night" id="" class="form-control summernote" cols="30" rows="4">
                                                        ...
                                                        @if (empty($productData['puppu_spent_night']))
                                                        @else
                                                            {{ $productData['puppu_spent_night'] }}
                                                        @endif
                                                    </textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="socialization" id="" class="form-control summernote" cols="30" rows="4">
                                                    ...
                                                    @if (empty($productData['socialization']))
                                                    @else
                                                        {{ $productData['socialization'] }}
                                                    @endif
                                                </textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="planning_another_puppy" id="" class="form-control summernote" cols="30" rows="4">
                                                    @if (empty($productData['planning_another_puppy']))
                                                    @else
                                                        {{ $productData['planning_another_puppy'] }}
                                                    @endif
                                                </textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="puppies_often_have" id="" class="form-control summernote" cols="30" rows="4">
                                                    @if (empty($productData['puppies_often_have']))
                                                    @else
                                                        {{ $productData['puppies_often_have'] }}
                                                    @endif
                                                </textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="please_tell_use_more" id="" class="form-control summernote" cols="30" rows="4">
                                                    @if (empty($productData['please_tell_use_more']))
                                                    @else
                                                        {{ $productData['please_tell_use_more'] }}
                                                    @endif
                                                </textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="coat_color" id="" class="form-control summernote" cols="30" rows="4">
                                                        @if (empty($productData['coat_color']))
                                                        @else
                                                            {{ $productData['coat_color'] }}
                                                        @endif
                                                    </textarea>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="when_you_ideal" id="" class="form-control summernote" cols="30" rows="4">
                                                    @if (empty($productData['when_you_ideal']))
                                                    @else
                                                        {{ $productData['when_you_ideal'] }}
                                                    @endif
                                                </textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="if_you_checked" id="" class="form-control summernote" cols="30" rows="4">
                                                    ...
                                                    @if (empty($productData['if_you_checked']))
                                                    @else
                                                        {{ $productData['if_you_checked'] }}
                                                    @endif
                                                </textarea>
                                            </div>
