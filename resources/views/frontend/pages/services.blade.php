...
@section('main-content')
            ...
            <div class="row row-30 row-count">
                <div class="col-lg-4 col-sm-6 wow slideInLeft">
                    <article class="services">
                        <h3 class="services-title"><a href="#">SUBMIT THE FORM</a></h3>
                        <figure class="services-figure"><a href="#"><img
                                    src="{{ asset('website/images/services-01-370x230.jpg') }}" alt=""
                                    width="370" height="230" /></a></figure>
                        <p class="services-text">While working one on one with your personal trainer you and your pet will
                            learn the commands you desire to teach your dog. Sessions are typically 45 minutes to an hour,
                            once weekly.</p>
                    </article>
                </div>
                <div class="col-lg-4 col-sm-6 wow slideInUp">
                    <article class="services">
                        <h3 class="services-title"><a href="#"> RECEIVE </a></h3>
                        <figure class="services-figure"><a href="#"><img
                                    src="{{ asset('website/images/services-02-370x230.jpg') }}" alt=""
                                    width="370" height="230" /></a></figure>
                        <p class="services-text">We’re going to change the way you communicate with your dog. To do this,
                            we’ve designed every group class with you and your dog in mind to achieve the best results for
                            you and your dog.</p>
                    </article>
                </div>
                <div class="col-lg-4 col-sm-6 wow slideInRight">
                    <article class="services">
                        <h3 class="services-title"><a href="#">LET US KNOW HOW IT WENT</a></h3>
                        <figure class="services-figure"><a href="#"><img
                                    src="{{ asset('website/images/services-03-370x230.jpg') }}" alt=""
                                    width="370" height="230" /></a></figure>
                        <p class="services-text"> Everything you want and need in one package. Private Lessons, Group
                            Classes, Dog eLearning, and Customized Homework. We train your dog and teach you how to follow
                            through.</p>
                    </article>
                </div>
            </div>
    ...
    <br>
    <div class="container">
        <h5 class="text-center" style="font-family: Amatic Sc; font-size: 40px;">SERVICES FORM</h5>
            ...
            <div class="row row-sm-bottom row-20">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="exampleFormControlSelect3">First Name</label>
                        <input class="form-input" id="contact-2-first_name" type="text" name="first_name"
                            data-constraints="">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="exampleFormControlSelect3">Last Name</label>
                        <input class="form-input" id="contact-2-last_name" type="text" name="last_name"
                            data-constraints="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="exampleFormControlSel"> City,State, Country </label>
