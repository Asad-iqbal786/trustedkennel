      ...
      <div class="card-body">
        ...
        <div class="tab-content" id="nav-tabContent" style="border: none;">
          ...
          <div class="form-group">
            ...
            @if (Auth::guard('admin')->user()->type=="Vendor")
              {{-- <div class="form-group">
                <label for="type">Vendro Type</label>
          ...
          <div class="form-group">
              ...
              @if(!empty(Auth::guard('admin')->user()->admin_image))
                <a href="{{url('admin/images/admin_photos/admins/'.Auth::guard('admin')->user()->admin_image)}}" target="blank">View Image</a>
                <input type="hidden" name="current_admin_image" id="current_admin_image" value="{{Auth::guard('admin')->user()->admin_image}}">
              @endif
          </div>
