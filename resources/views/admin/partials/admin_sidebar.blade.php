<nav class="sidebar sidebar-offcanvas bg-dark" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item" style="background: none;">
            ...
            <a class="nav-link"
                @if (Session::get('page') == 'update_admin_details') style="background:#68616E !important; color:#fff !important;" @endif
            ...
            <div class="collapse" id="form-vendor">
                <ul class="nav flex-column sub-menu" style="background: none;">
                    <li class="nav-item"><a class="nav-link"
                            @if (Session::get('page') == 'update_admin_details') style="background:#68616E !important; color:#fff !important;"
        ...
        <li class="nav-item" style="background: none;">
            <a @if (Session::get('page') == 'all_admins') style="background:#68616E !important; color:#fff !important;" @endif
            ...
            <div class="collapse" id="form-payment">
                <ul class="nav flex-column sub-menu" style="background: none;">
                    <li class="nav-item"><a class="nav-link"
                            @if (Session::get('page') == 'all_admins') style="background:#68616E !important; color:#fff !important;"
        ...
        <li class="nav-item" style="background: none;">
            <a @if (Session::get('page') == 'all_users') style="background:#68616E !important; color:#fff !important;" @endif
            ...
            <div class="collapse" id="form-users">
                <ul class="nav flex-column sub-menu" style="background: none;">
                    <li class="nav-item"><a class="nav-link"
                            @if (Session::get('page') == 'all_users') style="background:#68616E !important; color:#fff !important;"
              @else style="background:none;" @endif
        ...
        <li class="nav-item" style="background: none;">
            ...
            <a @if (
                ...
                ) style="background:#68616E !important; color:#fff !important;" @endif
            ...
            <div class="collapse" id="form-category">
                <ul class="nav flex-column sub-menu" style="background: none;">
                    <li class="nav-item"><a class="nav-link"
                            @if (Session::get('page') == 'all_categories') style="background:#68616E !important; color:#fff !important;"
              @else style="background:none;" @endif
                            href="{{ route('addEditCategories') }}">Breed </a></li>

                    <li class="nav-item"><a class="nav-link"
                            @if (Session::get('page') == 'all_types') style="background:#68616E !important; color:#fff !important;"
                @else style="background:none;" @endif
              ...
              @else style="background:#none;" @endif
                    ...
                    <li class="nav-item"><a class="nav-link"
                            @if (Session::get('page') == 'vendor_application') style="background:#68616E !important; color:#fff !important;"
                    @else style="background:none;" @endif
                            href="{{ route('adminApplication') }}">All Application </a></li>


                            <li class="nav-item"><a class="nav-link"
                                @if (Session::get('page') == 'admin_commission') style="background:#68616E !important; color:#fff !important;"
                        @else style="background:none;" @endif
                    ...
                    @else style="background:none;" @endif
                            ...
                            <li class="nav-item"><a class="nav-link"
                                @if (Session::get('page') == 'all_payment_withdraw') style="background:#68616E !important; color:#fff !important;"
                        @else style="background:none;" @endif
