                  ...
                  @foreach ($category as $item)
                    <tr>
                      ...
                      <td>
                        ...
                        @endif
                      <td> <a href="{{route('addEditCategories',$item['id'])}}"><i class="mdi mdi-pencil-box"></i></a> / 
                        <a href="{{route('categoryDestroy',$item['id'])}}" onclick="return confirm('Are you sure to delete?')"><i class="mdi mdi-file-excel-box"></i></a>
                      </td>
                    </tr>    
                  @endforeach                 
